...
import CNN.src.FastNet.sunfish as sunfish
    ...
    for i in range(64):
        ...
        if availablePiecesBoard[i] != 0:
            ...
            if composedScore > maxScore:
                ...
                maxFromCoordinate, maxToCoordinate = coordinate, scoreToCoordinateIndex(
                    np.argmax(boardToScores(availableMovesBoard)))
