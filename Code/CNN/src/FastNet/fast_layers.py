import numpy as np
try:
  from CNN.src.FastNet.im2col_cython import col2im_cython, im2col_cython
  from CNN.src.FastNet.im2col_cython import col2im_6d_cython
except ImportError:
  print('run the following from the cs231n directory and try again:')
  print('python setup.py build_ext --inplace')
  print('You may also need to restart your iPython kernel')

from CNN.src.FastNet.im2col import *
...
def conv_forward_fast(x, w, b, conv_param):
  ...
  strides = int(x.itemsize) * np.array(strides).astype(int)
  x_stride = np.lib.stride_tricks.as_strided(x_padded.astype(int),
